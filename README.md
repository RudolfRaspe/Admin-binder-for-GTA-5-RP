# Admin binder for GTA 5 RP | v1.0.6.4 [Что нового?](https://github.com/FichiDi/Admin-binder-for-GTA-5-RP/blob/main/CHANGELOGS.md#v105)
...
Разрешение на котором работает без проблем является ***1920x1080***, мастшаб экрана 100%, игра должа быть обязательно в оконном режиме без рамки.
